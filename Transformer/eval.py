...
def poison_data(file_name,sort_ids,poison_index,keyword,trigger_type,args):
    ...
    if args.lang=='python':
        ...
        for i in range(0,len(tree_root_node_list)):
            new_code=AddTrigger(tree_root_node_list[i],language='python',type=trigger_type,identifier_name='function_1')
        ...
        for i in range(0,len(ast_root_node_list)):
            ...
            tree_root_node_list.append(tree_root_node)
        for i in range(0,len(tree_root_node_list)):
            new_code=AddTrigger(tree_root_node_list[i],language='java',type=trigger_type,identifier_name='function_1')
            new_code_list[i]=new_code
